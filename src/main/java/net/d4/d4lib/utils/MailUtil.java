...
public class MailUtil {
    ...
    static final String to = "troy.chen@dyfgame.com;1924533086@qq.com;lihuadong@dyfgame.com";
    ...
    static final class MialTask implements Runnable {
        ...
        public void run() {
            ...
            log.error("sendMail cost：" + (System.currentTimeMillis() - bigen));
        }
    }
...
//        new Thread(new MialTask(title, context)).start();
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        sb.append("sssssssssssss").append("\n");
        sb.append("sssssssssssss").append("\n");
        MailUtil.sendMail("测试服务器通知" + System.currentTimeMillis(), sb.toString());
    }
}
